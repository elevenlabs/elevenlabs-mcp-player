...
var resourceUri = "ui://get-time/mcp-app.html";
server.registerTool("get-time", {
    title: "Get Time",
    description: "Returns the current server time.",
    inputSchema: {},
    outputSchema: { time: z.string() },
    _meta: { ui: { resourceUri: resourceUri } }, // Links tool to UI
    ...
    return __generator(this, function (_a) {
        ...
        return [2 /*return*/, {
                ...
                structuredContent: { time: time },
            }];
    });
}); });
server.registerResource(resourceUri, resourceUri, { mimeType: "text/html;profile=mcp-app" }, function () { return __awaiter(void 0, void 0, void 0, function () {
    var html;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, promises_1.default.readFile(node_path_1.default.join(import.meta.dirname, "dist", "mcp-app.html"), "utf-8")];
            case 1:
                html = _a.sent();
                return [2 /*return*/, {
                        contents: [
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                res.on("close", function () { return transport.close(); });
